...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-scysun-app.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-scysun-app)
...
Please see the [issues](https://github.com.scysun.app/com-scysun-app/issues) section
...
At that point all the source files that were located in ____com.scysun.app__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.scysun.app.R__) will now be renamed
...
## Contributors
Thank you to all the [contributors](http://www.github.com.scysun.app/com-scysun-app/contributors) on
...
[pull requests](https://github.com.scysun.app/com-scysun-app/pulls).
