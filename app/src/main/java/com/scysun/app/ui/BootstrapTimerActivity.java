...
import com.scysun.app.core.PauseTimerEvent;
import com.scysun.app.core.ResumeTimerEvent;
import com.scysun.app.core.StopTimerEvent;
import com.scysun.app.core.TimerPausedEvent;
import com.scysun.app.core.TimerService;
import com.scysun.app.core.TimerTickEvent;
...
public class BootstrapTimerActivity extends BootstrapFragmentActivity implements View.OnClickListener {
    ...
    private void setFormattedTime(long millis) {
        final String formattedTime = FBDateUtils.formatTime(millis);
